...
const CaptionLabel    = Extension.imports.src.captionLabel;
const Enum            = Extension.imports.src.enum;
const InputHandler    = Extension.imports.src.inputHandler;
const ListProvider    = Extension.imports.src.listProvider;
const SwitcherList    = Extension.imports.src.switcherList;
const Util            = Extension.imports.src.util;
